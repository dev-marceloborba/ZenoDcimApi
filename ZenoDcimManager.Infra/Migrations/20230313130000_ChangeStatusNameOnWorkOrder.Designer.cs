...
namespace ZenoDcimManager.Infra.Migrations
{
    ...
    [Migration("20230313130000_ChangeStatusNameOnWorkOrder")]
    partial class ChangeStatusNameOnWorkOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZenoDcimManager.Domain.AutomationContext.Entities.BuildingCardSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BuildingCardSettings", (string)null);
                });

            modelBuilder.Entity("ZenoDcimManager.Domain.AutomationContext.Entities.EquipmentCardSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EquipmentCardSettings", (string)null);
                });
            ...
            modelBuilder.Entity("ZenoDcimManager.Domain.AutomationContext.Entities.SiteCardSettings", b =>
                {
                    ...
                    b.ToTable("SiteCardSettings", (string)null);
                });
            ...
            modelBuilder.Entity("ZenoDcimManager.Domain.ServiceOrderContext.Entities.WorkOrderEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkOrderEvent", (string)null);
                });
            ...
            modelBuilder.Entity("ZenoDcimManager.Domain.ZenoContext.Entities.RackEquipment", b =>
                {
                    ...
                    b.Property<int>("RackEquipmentOrientation")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZenoDcimManager.Domain.AutomationContext.Entities.BuildingCardSettings", b =>
                {
                    b.HasOne("ZenoDcimManager.Domain.ZenoContext.Entities.Building", "Building")
                        ...
                        .HasForeignKey("ZenoDcimManager.Domain.AutomationContext.Entities.BuildingCardSettings", "BuildingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsOne("ZenoDcimManager.Domain.ActiveContext.ValueObjects.ParameterInfo", "Parameter1", b1 =>
                        {
                            ...
                            b1.HasKey("BuildingCardSettingsId");
                    ...
                    b.OwnsOne("ZenoDcimManager.Domain.ActiveContext.ValueObjects.ParameterInfo", "Parameter1", b1 =>
                        {
                            ...
                            b1.HasKey("EquipmentCardSettingsId");
                    ...
                    b.OwnsOne("ZenoDcimManager.Domain.ActiveContext.ValueObjects.ParameterInfo", "Parameter1", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                .HasForeignKey("RoomCardSettingsId");
                    ...
                    b.OwnsOne("ZenoDcimManager.Domain.ActiveContext.ValueObjects.ParameterInfo", "Parameter1", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                .HasForeignKey("SiteCardSettingsId");
            ...
            modelBuilder.Entity("ZenoDcimManager.Domain.ServiceOrderContext.Entities.WorkOrderEvent", b =>
                {
                    b.HasOne("ZenoDcimManager.Domain.ServiceOrderContext.Entities.WorkOrder", "WorkOrder")
