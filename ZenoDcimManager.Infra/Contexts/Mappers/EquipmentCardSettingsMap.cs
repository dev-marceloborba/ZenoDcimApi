...
{
    public class EquipmentCardSettingsMap : IEntityTypeConfiguration<EquipmentCardSettings>
    {
        public void Configure(EntityTypeBuilder<EquipmentCardSettings> builder)
        {
            builder.ToTable("EquipmentCardSettings");
            builder.HasIndex(x => x.EquipmentId).IsUnique(false);
            // parameter 1
