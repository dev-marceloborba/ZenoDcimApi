...
{
    public class SiteCardSettingsMap : IEntityTypeConfiguration<SiteCardSettings>
    {
        public void Configure(EntityTypeBuilder<SiteCardSettings> builder)
        {
            builder.ToTable("SiteCardSettings");
